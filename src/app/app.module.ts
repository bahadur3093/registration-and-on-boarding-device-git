...
import { faUser, faPowerOff, faCheckCircle, faCloudDownloadAlt, faExchangeAlt, faExclamationCircle, faExclamationTriangle, faTimesCircle } from '@fortawesome/free-solid-svg-icons';
...
export class AppModule {
  constructor(private library: FaIconLibrary) {
    library.addIcons(faUser, faPowerOff, faCheckCircle, faCloudDownloadAlt, faExchangeAlt, faExclamationCircle, faExclamationTriangle, faTimesCircle);
  }
 }
